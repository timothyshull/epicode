...
vector<int> inverted_preorder_traversal(const unique_ptr<Binary_tree_node<int>>&);

// @include
vector<int> postorder_traversal(const unique_ptr<Binary_tree_node<int>>& tree)
{
    vector<int> sequence = inverted_preorder_traversal(tree);
    reverse(sequence.begin(), sequence.end());
    return sequence;
}

vector<int> inverted_preorder_traversal(const unique_ptr<Binary_tree_node<int>>& tree)
{
